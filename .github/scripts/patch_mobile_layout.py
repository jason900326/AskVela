...
old_styles = """  stage: { minHeight: 430, borderRadius: 28, borderWidth: 1, borderColor: '#3B2550', backgroundColor: '#1A1025', alignItems: 'center', justifyContent: 'flex-start', overflow: 'hidden', padding: 16, paddingBottom: 104 },
...
new_styles = """  stage: { height: 418, borderRadius: 28, borderWidth: 1, borderColor: '#3B2550', backgroundColor: '#1A1025', alignItems: 'center', justifyContent: 'flex-start', overflow: 'hidden' },
  stageTarot: { backgroundColor: '#160D20', borderColor: '#5B386D' },
...
one(old_styles, new_styles, 'fixed stage styles')
one(
...
old_reading = """  readingStrip: { width: '100%', flexDirection: 'row', gap: 10 },
...
new_reading = """  readingStrip: { width: '100%', height: 184, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
...
one(old_reading, new_reading, 'reading strip size')
old_mini = """  miniCardRow: { width: '100%', flexDirection: 'row', gap: 10 },
...
new_mini = """  miniCardRow: { width: '100%', height: 154, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
...
one(old_mini, new_mini, 'thinking mini cards')
