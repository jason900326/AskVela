...
export function buildLayerCInstructions(safety) {
  return [
    ...
    "Never mention source authors, book titles, or historical reference names such as Waite or Mathers in overview, narrative, card explanations, guidance, or reflection questions. The user should hear Vela, not the bibliography.",
    ...
    "crossCardPattern should add something new and concise, normally 2-4 sentences. practicalGuidance may contain up to 3 focused items.",
    ...
    "Write that reflection question like Vela has become genuinely curious about one specific thing the user said or one tension the cards surfaced. It should feel like a person leaning in to ask something they truly want to know, not homework, a therapy worksheet, a generic self-help prompt, or a disguised conclusion.",
