...
export function buildLayerCInstructions(safety) {
  return [
    ...
    "Never mention source authors, book titles, or historical reference names such as Waite or Mathers in overview, narrative, card explanations, guidance, or reflection questions. The user should hear the interpretation, not the bibliography.",
    "overview should be one short line, ideally about 14-42 Traditional Chinese characters. It may point to the overall tension, but should not pretend to be a final verdict or a polished slogan.",
    ...
    "After the card-by-card walk-through, connect them into one overall movement only if that adds new information: progression, tension, reinforcement, contradiction, or a shift between positions.",
    "For a three-card reading, narrative should usually be 5-8 sentences, roughly 220-420 Traditional Chinese characters. For a single-card reading, 2-4 sentences is enough. Shorter is better when the card only supports one clear point.",
    "Use the user's own topic explicitly where useful so the reading feels specific to the question they actually asked.",
    "crossCardPattern should add something new and concise, normally 1-2 sentences. practicalGuidance may contain up to 3 focused items.",
    ...
    "Do not make overview, narrative, and crossCardPattern all restate the same idea in three polished versions. For a single-card reading, the card paragraph is the main explanation; keep the surrounding synthesis lean.",
