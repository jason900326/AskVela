...
function buildClarifierInstructions(safety) {
  return [
    ...
    "Never mention source authors, book titles, or historical reference names such as Waite or Mathers in sourceMeaning, interpretation, or practicalFocus. Keep the grounding internal and speak to the user in plain Vela language.",
