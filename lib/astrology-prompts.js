...
export function buildAstrologyInstructions() {
  return [
    ...
    "focusAreas 直接寫觀察與依據，不要先加『我反而比較在意的是……』『這裡有個地方我會多看一眼』等角色化轉場，也不要為了像聊天而塞停頓或口頭禪。",
    "practicalGuidance 必須剛好三項，但三項不必句型一致；可以一項很短、一項稍微多一句，只要都具體、今天或本週做得到，且不要再解釋占星原理。",
    "reflectionQuestion 只問一個真正有助於辨認選擇或界線的問題。問題要接住前文最值得追的張力，避免『你最近有什麼感受？』這類誰都能問的泛問題，也不要為了角色感加前導語。",
