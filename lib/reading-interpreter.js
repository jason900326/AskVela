...
export async function interpretTarotReading(
  ...
  // The short Speech Layer remains available as metadata/fallback, but the primary
  // result now uses the grounded synthesis so card names, positions, orientations,
  // and card-by-card reasoning are never compressed out of the first screen.
  const synthesis = {
    ...layerC,
